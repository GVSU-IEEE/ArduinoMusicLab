 ...
 * @author Tom Igoe
 * 
 * This is a set of pitch constants, equating musical notes to their
 * corresponding frequencies. This was adopted from a similar file 
 * provided by Tom Igoe at 
 * https://www.arduino.cc/en/Tutorial/toneMelody.
 * 
 * Note that 'flats' are not defined, so you will have to use the 
